...
export default function Home() {
    return (
<section className="flex justify-between items-start gap-4 py-8 md:py-10 blurred-background h-full">
    <div className="w-1/2 items-center text-center p-4 rounded">
